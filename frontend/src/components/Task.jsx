              ...
              {visibleTasks.map((task) => (
                <li key={task.id} className="group grid min-h-16 grid-cols-[44px_minmax(0,1fr)] items-start gap-x-2 gap-y-1 px-2 py-2 sm:flex sm:flex-nowrap sm:px-4">
                  ...
                  <div className="min-w-0 flex-1 pt-1.5">
                    {editable === task.id ? (
                      <input
                        ...
                        maxLength={255}
                        className="h-11 w-full rounded-md border border-emerald-800 bg-white px-3 outline-none ring-3 ring-emerald-800/15"
                      />
                    ) : (
                      <div>
                  ...
                  <div className="col-start-2 flex flex-none items-center sm:ml-0">
                    {editable === task.id ? (
                      <>
                        <button type="button" onClick={() => saveTask(task)} aria-label="Save task" className="grid size-11 cursor-pointer place-items-center rounded-lg text-emerald-800 hover:bg-emerald-50 focus-visible:outline-3 focus-visible:outline-offset-2 focus-visible:outline-emerald-800">
                          <Save aria-hidden="true" className="size-4" />
                        </button>
                        <button type="button" onClick={() => setEditable(null)} aria-label="Cancel editing" className="grid size-11 cursor-pointer place-items-center rounded-lg text-slate-500 hover:bg-slate-100 focus-visible:outline-3 focus-visible:outline-offset-2 focus-visible:outline-emerald-800">
